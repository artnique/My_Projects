		...
		_show: function(title, msg, value, type, callback) {
			...
			$("BODY").append(
			  '<div id="popup_container">' +
			  	'<div id="popup_title">'+
			   		'<h4 class="fl">提示</h4>' +
			    	'<i class="iconsimg fr error" id="popup_close"></i>'+
			    '</div>'+
			...
			switch( type ) {
				...
				break;
				case 'confirm':
					$("#popup_message").after('<div id="popup_panel"><input type="button" value="' + $.alerts.okButton + '" id="popup_ok" class="Btn ok" /> <input type="button" value="' + $.alerts.cancelButton + '" id="popup_cancel" class="Btn no" /></div>');
					$("#popup_ok").click( function() {
						$.alerts._hide();
